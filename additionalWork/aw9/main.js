...
UserElement.classList.add('User')
    ...
    addressStreet.innerText = usersListElement.address.street;
    let addressSuite = document.createElement("div");
    addressSuite.innerText = usersListElement.address.suite;
    let addressCity = document.createElement("div");
    addressCity.innerText = usersListElement.address.city;
...
//GEO
    ...
    geo.innerText = `координати:`
    let addressGeoLan = document.createElement("div");
    addressGeoLan.innerText = usersListElement.address.geo.lat;
    let addressGeoLng = document.createElement("div");
    addressGeoLng.innerText = usersListElement.address.geo.lng;
    geo.append(addressGeoLan, addressGeoLng)
    //

    let phone = document.createElement("div");
    phone.innerText =`Номер Телефону: ${usersListElement.phone}`;

    let website = document.createElement("div");
    website.innerText = usersListElement.website;
///company
    let company = document.createElement("div");
    company.innerText='Компанія:';
    let companyName = document.createElement("div");
    companyName.innerText = usersListElement.company.name;
    ...
    address.append(addressStreet, addressSuite, geo)
    UserElement.append(id, email, username, name, address,phone,website,company)
